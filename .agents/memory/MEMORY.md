...
- [Didit verification contract](didit-verification-contract.md) — identity access must use short-lived server-bound challenges and fresh HMAC webhooks as the source of truth
