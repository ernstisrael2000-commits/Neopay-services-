...
async function startServer() {
  ...
  app.use((_req, res, next) => {
    ...
    res.setHeader('Content-Security-Policy', "default-src 'self'; base-uri 'self'; frame-ancestors 'none'; object-src 'none'; img-src 'self' data: blob: https:; font-src 'self' data: https:; style-src 'self' 'unsafe-inline' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://quge5.com https://auqot.com https://ekhay.com https://b3mny.com https://tzegilo.com https://apis.google.com https://accounts.google.com https://www.gstatic.com; frame-src 'self' https://accounts.google.com https://*.firebaseapp.com; connect-src 'self' https: wss:;");
    if (process.env.NODE_ENV === 'production') {
