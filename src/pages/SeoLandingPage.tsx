...
const CONTENT: Record<SeoLandingPath, LandingContent> = {
  '/recharge-free-fire': {
    ...
    intro: 'Solutionpam propose un catalogue de recharges de jeux. Consultez la disponibilité de Free Fire et des autres offres avant de passer votre commande.',
    sections: [
  ...
  '/abonnements': {
    ...
    intro: 'Le catalogue Solutionpam réunit des abonnements numériques et services de streaming selon les disponibilités affichées au moment de la commande.',
    sections: [
  ...
  '/paiements': {
    ...
    intro: 'Solutionpam regroupe des recharges de cartes, des services numériques et des options de paiement disponibles pour les utilisateurs en Haïti.',
    sections: [
      ...
      { title: 'Suivre votre demande', body: 'Connectez-vous à votre espace Solutionpam pour consulter les informations relatives à vos opérations et recevoir les mises à jour utiles.' },
    ],
    primaryHref: '/produits',
    primaryLabel: 'Consulter le catalogue',
  },
  '/contact': {
    eyebrow: 'Support Solutionpam',
    intro: 'L’équipe Solutionpam est disponible pour répondre aux questions concernant les recharges, services numériques, colis et expéditions.',
    sections: [
    ...
    primaryHref: 'https://wa.me/50944813185?text=Bonjour%20Solutionpam%2C%20j%27ai%20besoin%20d%27aide.',
    primaryLabel: 'Contacter sur WhatsApp',
  },
  '/a-propos': {
    eyebrow: 'Solutionpam en Haïti',
    intro: 'Solutionpam est une plateforme qui rassemble des services numériques, des recharges, le suivi de colis, des solutions d’expédition et des formations en ligne.',
    sections: [
...
export default function SeoLandingPage({ path }: { path: SeoLandingPath }) {
  ...
  return (
    <article className="mx-auto w-full max-w-4xl px-4 pb-16 pt-8 sm:px-6 sm:pt-12">
      ...
      <nav className="mt-8 flex flex-wrap gap-3 text-sm font-bold text-primary" aria-label="Liens vers les services Solutionpam">
