...
const QUICK_LINKS = [
  ...
  { key: 'games', label: 'Top up', icon: Gamepad2, iconClass: 'text-emerald-600', tileClass: 'bg-emerald-50 border-emerald-100', destination: { type: 'catalog', tab: 'games' as const } },
